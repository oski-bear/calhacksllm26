...
def main():
    ...
    with sync_playwright() as p:
        ...
        expect(page.get_by_text("$620/mo")).to_be_visible(timeout=15000)
        expect(page.get_by_text("Application time saved")).to_be_visible(timeout=15000)
        ...
        expect(page.get_by_text("Up to $546 / month in grocery benefits")).to_be_visible(timeout=15000)
        expect(page.get_by_text("$74 / month produce benefit + WIC foods")).to_be_visible(timeout=15000)
        expect(page.get_by_text("60 minutes")).to_be_visible(timeout=15000)
        expect(page.get_by_text("10 minutes")).to_be_visible(timeout=15000)
        expect(page.get_by_role("link", name="Apply on BenefitsCal")).to_be_visible(timeout=15000)
        expect(page.get_by_role("link", name="Eligibility + proof PDF")).to_be_visible(timeout=15000)
        expect(page.get_by_role("link", name="How to get WIC")).to_be_visible(timeout=15000)
